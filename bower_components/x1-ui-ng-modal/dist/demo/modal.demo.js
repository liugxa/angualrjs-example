...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('modal/index.rtl.html',
    ...
    '<head>\n' +
    '	<meta charset="utf-8">\n' +
    '	<title>IBM Commerce Product UI Modal Demo</title>\n' +
    ...
    '	<!--<link rel="stylesheet" href="modal.demo.css">-->\n' +
    '	<!--<link rel="stylesheet" href="modal.demo.rtl.css">-->\n' +
    '</head>\n' +
    '<body dir="rtl">\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('modal/modal.doc.html',
    ...
    '</ul>\n' +
    '\n' +
    '<h3 class="page-header">Attribute options for <code>&lt;modal&gt;</code></h3>\n' +
    ...
    '<p><code>dismissAll</code> - this call will close all the currently opened modals.</p>\n' +
    '\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('modal/examples/contextual.demo.html',
    ...
    '<div class="bs-example" id="example3">\n' +
    ...
    '<tabset>\n' +
    '	<tab heading="HTML">\n' +
    '		<x1-prism element="#example3" lang="html"></x1-prism>\n' +
    '	</tab>\n' +
    '	<tab heading="JS">\n' +
    '			<pre x1-prism lang="javascript">\n' +
    '				angular\n' +
    '				.module(&quot;x1.ui.modal.demo&quot;, [\n' +
    '					&quot;x1.ui.modal&quot;\n' +
    '				])\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('modal/examples/simple.demo.html',
    ...
    '<div class="bs-example" id="example1">\n' +
    '	<button class="btn btn-default" type="button" ng-click="openModal(simple)">Quick and Easy</button>\n' +
    '</div>\n' +
    '<tabset>\n' +
    '	<tab heading="HTML">\n' +
    '		<x1-prism element="#example1" lang="html"></x1-prism>\n' +
    '	</tab>\n' +
    '	<tab heading="JS">\n' +
    '		<pre x1-prism lang="javascript">\n' +
    '			angular\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('modal/examples/sizes.demo.html',
    ...
    '<div class="bs-example" id="example2">\n' +
    '	<button class="btn btn-default" type="button" ng-click="openModal(smallModal)">Small modal - 320px wide</button>\n' +
    '	<button class="btn btn-default" type="button" ng-click="openModal(mediumModal)">Medium (Default) modal - 640px wide</button>\n' +
    ...
    '<tabset>\n' +
    '	<tab heading="HTML">\n' +
    '		<x1-prism element="#example2" lang="html"></x1-prism>\n' +
    '	</tab>\n' +
    '	<tab heading="JS">\n' +
    '		<pre x1-prism lang="javascript">\n' +
    '			angular\n' +
